...
var Collections = {
	Videos: Backbone.Collection.extend({
		model: Models.Video,
		url: 'https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=30&playlistId=PLTNl117aSmvEHA4RaCmhOu76SaZRakClG &key=AIzaSyCkOkN3M_gNDpeQJSObnp5KfxRfkU8HlG8',
		parse: function(resp) {
